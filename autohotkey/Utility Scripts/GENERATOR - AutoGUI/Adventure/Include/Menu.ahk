...
Menu MenuFile, Add
AddMenu("MenuFile", "Open Folder in File Manager", "M_OpenFolder", IconLib, -14)
AddMenu("MenuFile", "Open in Command Prompt", "OpenCommandPrompt", IconLib, -15)
Menu MenuFile, Add
AddMenu("MenuFile", "&Close File`tCtrl+W", "CloseTab", IconLib, -17)
...
AddMenu("MenuSession", "Manage Sessions...", "ShowSessionsManager", IconLib, -37)
...
AddMenu("MenuFavorites", "Manage Favorites...", "ShowFavoritesManager", IconLib, -37)
...
Menu MenuOptions, Add, Caret Settings..., ShowCaretDialog
...
; Debug Menu
AddMenu("MenuDebug", "Start Debugging`tF5", "M_DebugRun", IconLib, -66)
AddMenu("MenuDebug", "Break`tBreak", "DebugBreak", IconLib, -68)
AddMenu("MenuDebug", "Stop Debugging`tF8", "DebugStop", IconLib, -69)
Menu MenuDebug, Add
AddMenu("MenuDebug", "Attach Debugger...", "ShowAttachDialog", IconLib, -70)
Menu MenuDebug, Add
AddMenu("MenuDebug", "Step Into`tF6", "StepInto", IconLib, -72)
AddMenu("MenuDebug", "Step Over`tF7", "StepOver", IconLib, -73)
AddMenu("MenuDebug", "Step Out`tShift+F6", "StepOut", IconLib, -74)
Menu MenuDebug, Add
AddMenu("MenuDebug", "Toggle Breakpoint`tF4", "ToggleBreakpoint", IconLib, -75)
AddMenu("MenuDebug", "Delete All Breakpoints", "DeleteBreakpoints", IconLib, -76)
Menu MenuDebug, Add
AddMenu("MenuDebug", "Variables", "ShowVarList", IconLib, -78)
AddMenu("MenuDebug", "Call Stack", "ShowCallStack", IconLib, -88)
AddMenu("MenuDebug", "Error Stream", "ShowStderr", IconLib, -89)
Menu MenuDebug, Add
AddMenu("MenuDebug", "Debug Settings...", "SetDebugPort", IconLib, -37)
...
Menu MenuAHK, Add
AddMenu("MenuAHK", "Debug", ":MenuDebug", IconLib, -65)
AddMenu("MenuAhkHelp", "AutoHotkey &Help File", "AhkHelp", "hh.exe")
AddMenu("MenuAHK", "Help", ":MenuAhkHelp", IconLib, -90)
