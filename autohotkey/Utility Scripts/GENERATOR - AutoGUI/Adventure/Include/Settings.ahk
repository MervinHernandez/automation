LoadSettings() {
    ...
    ; AutoComplete
    IniRead g_AutoComplete, %IniFile%, Options, AutoComplete, 0
    IniRead g_AutoCMinLength, %IniFile%, Options, AutoCMinLength, 3
    ...
    IniRead g_Gradient, %IniFile%, Options, Gradient, 3FBBE3|3FBBE3|0080C0|0080C0
    ...
    IniRead g_DbgPort, %IniFile%, AHK, DebugPort, 9001
...
SaveSettings() {
    ...
    IniWrite %g_AutoCMinLength%, %IniFile%, Options, AutoCMinLength
    ...
    IniWrite %g_DbgPort%, %IniFile%, AHK, DebugPort
...
/*
TB_EnableButton(BtnID, Enable) {
    SendMessage 0x401, %BtnID%, %Enable%,, ahk_id %g_hToolbar% ; TB_ENABLEBUTTON
}
*/
