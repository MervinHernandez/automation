...
Global C
    ...
    , Unicode := 1
    , PausePrompt := 0
    , g_Gradient := "3FBBE3|3FBBE3|008EBC|008EBC"
...
Gui Add, Pic, hWndhGrad1 x11 y10 w606 h26, % "HBITMAP:" . CreateGradient(606, 26)
...
Gui Add, Pic, hWndhGrad2 x11 y257 w605 h26, % "HBITMAP:" . CreateGradient(606, 26)
Gui Font, s9 cWhite Bold, Segoe UI
...
ShowSettings:
    ...
    Gui Add, Pic, x9 y10 w637 h26, % "HBITMAP:" . CreateGradient(637, 26)
    Gui Font, s9 cWhite Bold, Segoe UI
