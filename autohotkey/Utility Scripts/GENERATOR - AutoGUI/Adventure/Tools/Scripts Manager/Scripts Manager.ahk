...
Global g_AppName := "AutoHotkey Scripts Manager"
     , g_Version := "1.2.6"
     , g_AppData := A_AppData . "\AmberSoft\Adventure"
     , IniFile := GetIniFileLocation("Scripts Manager.ini")
     ...
     , IconLib := A_ScriptDir . "\..\..\Icons\Scripts Manager.icl"
...
Gui 1: New, +hWndg_hWndMain +Resize, %g_AppName%
...
IniRead W, %IniFile%, Window, Width, 734
IniRead H, %IniFile%, Window, Height, 441
...
IniRead Columns, %IniFile%, Window, Columns, 177|424|49|79
...
SaveSettings() {
    ...
    ; Options
    IniWrite %g_AlwaysOnTop%, %IniFile%, Options, AlwaysOnTop
    IniWrite %g_HideWhenMinimized%, %IniFile%, Options, HideWhenMinimized
    IniWrite %g_ConfirmAction%, %IniFile%, Options, ConfirmAction
    IniWrite %g_Notifications%, %IniFile%, Options, Notifications
    ...
    IniWrite %Columns%, %IniFile%, Window, Columns
}
...
LoadOptions() {
    IniRead g_AlwaysOnTop, %IniFile%, Options, AlwaysOnTop, 0
    IniRead g_HideWhenMinimized, %IniFile%, Options, HideWhenMinimized, 0
    IniRead g_ConfirmAction, %IniFile%, Options, ConfirmAction, 1
    IniRead g_Notifications, %IniFile%, Options, Notifications, 0
...
CreateIniFile() {
    ...
    If (!FileExist(IniFile)) {
        ...
        If (ErrorLevel) {
            ...
            IniFile := g_AppData . "\Scripts Manager.ini"
            FileDelete %IniFile%
            FileAppend %Sections%, %IniFile%, UTF-16
        }
    }

    Return FileExist(IniFile)
}
